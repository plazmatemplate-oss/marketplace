...
export default function BestSalesClientPage() {
  const pageSize = 12;
  const {
    data,
    isLoading,
        ...
        <div className="page-card">
          {isLoading ? (
            <div className="py-16 flex flex-col justify-center items-center gap-3">
              ...
              <span className="text-theme-gray-500 font-medium text-sm">Loading best sales...</span>
            </div>
          ) : products.length === 0 ? (
            <div className="py-16 text-center text-theme-gray-500 font-medium">
              No products found in Best Sales.
            </div>
          ) : (
            <>
              ...
              <div ref={observerRef} className="py-8 flex justify-center items-center w-full">
                {isFetchingNextPage ? (
                  ...
                  <p className="text-xs text-theme-gray-400 font-medium">You&apos;ve reached the end of Best Sales</p>
                )}
              </div>
            </>
          )}
