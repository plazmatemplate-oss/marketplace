...
export const metadata: Metadata = {
  title: 'Login | Plazma Themes',
  description: 'Log in to your Plazma Themes account.',
  keywords: ["Plazma Themes login", "account sign in", "user login", "ecommerce template account"],
  alternates: {
    canonical: "/login",
  },
};
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
            ...
            <div className="w-full lg:w-5/12 flex flex-col gap-6 pt-4">
              ...
              <p className="text-theme-gray-600 text-[14.5px] leading-relaxed max-w-lg">
                If you don&apos;t have an account, no worries! Sign in now to get started and unlock all features.
              </p>
              <div>
                <Link
                  href="/registration"
