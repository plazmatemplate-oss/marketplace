        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="relative lg:sticky lg:top-32 self-start">
              <Image 
                src="https://plazmathemes.com/img/cms/about.png" 
          ...
          <div className="bg-theme-light-blue rounded-[40px] px-8 py-16 lg:p-20 flex flex-col gap-16 lg:gap-20 shadow-sm border border-theme-light-blue/50">
            ...
            <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-center md:items-start max-w-5xl mx-auto">
              <div className="w-32 h-32 lg:w-40 lg:h-40 shrink-0 bg-white rounded-full flex items-center justify-center shadow-sm">
                <Image src="https://plazmathemes.com/img/cms/Support.png" alt="Support" width={80} height={80} className="w-16 h-16 lg:w-20 lg:h-20 object-contain" />
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-center md:items-start max-w-5xl mx-auto">
              <div className="w-32 h-32 lg:w-40 lg:h-40 shrink-0 bg-white rounded-full flex items-center justify-center shadow-sm">
                <Image src="https://plazmathemes.com/img/cms/Customization.png" alt="Personalization" width={80} height={80} className="w-16 h-16 lg:w-20 lg:h-20 object-contain" />
              </div>
              <div className="flex flex-col gap-4 text-center md:text-left pt-2 lg:pt-6">
            ...
            <div className="flex flex-col md:flex-row gap-8 lg:gap-16 items-center md:items-start max-w-5xl mx-auto">
              <div className="w-32 h-32 lg:w-40 lg:h-40 shrink-0 bg-white rounded-full flex items-center justify-center shadow-sm">
                <Image src="https://plazmathemes.com/img/cms/Innovation.png" alt="Innovation" width={80} height={80} className="w-16 h-16 lg:w-20 lg:h-20 object-contain" />
              </div>
              <div className="flex flex-col gap-4 text-center md:text-left pt-2 lg:pt-6">
