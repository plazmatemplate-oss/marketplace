...
function LogoBlock({ isMobile = false }: Readonly<{ isMobile?: boolean }>) {
  return (
    <div className={`flex flex-col space-y-3 pb-2 md:pb-0 ${isMobile ? "items-center text-center w-full" : "lg:border-r border-theme-gray-100 lg:pr-8"}`}>
      ...
      <p className={`text-[13px] text-theme-gray-600 leading-relaxed max-w-95 ${isMobile ? "mx-auto" : ""}`}>
        Plazma Themes is a marketplace where you can find everything you need to create a stunning website. Explore a wide collection of high-quality themes, templates, plugins, and digital products created by talented independent developers and designers. Build, customize, and launch your own unique website with Plazma Themes.
      </p>
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-3 md:gap-4 pb-8 border-b border-theme-gray-100 mb-6 md:mb-10">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            ...
            <Link href="https://instagram.com/plazmathemes" className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-theme-gray-700 hover:bg-social-vimeo hover:text-white transition-colors shadow-sm" target="_blank" rel="noopener noreferrer">
