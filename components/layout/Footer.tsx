  ...
  return (
    <div className={`flex flex-col space-y-3 pb-2 md:pb-0 ${isMobile ? "items-center text-center w-full" : "lg:border-r border-theme-gray-100 lg:pr-8"}`}>
      <Link href="/" className="mb-2 w-full flex justify-center md:justify-start">
        {isMobile ? (
          <Image src="https://plazmathemes.com/img/logo-1729574384.jpg" alt="Plazma Themes Logo" width={180} height={43} className="w-45 h-auto object-contain" />
        ) : (
          <Image src="https://plazmathemes.com/img/logo-1729574384.jpg" alt="Plazma Themes Logo" width={250} height={60} className="w-62.5 h-auto object-contain" />
        )}
      </Link>
